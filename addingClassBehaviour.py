                ...
                if hasattr(v, "__call__"):
                    ...
                    if v.__name__[0] == "_" or v.__name__[0].islower():
                        ...
                        if v.__doc__ is None:
                            ...
                            raise ValueError(
                                "Make sure to Provide Documentation check {}".format(
                                    v.__name__
                                )
                            )
                        else:
                        ...
                        raise ValueError(
                            "Function should start with Lower case :{}".format(
                                v.__name__
                            )
                        )
        else:
            raise ValueError(
                "Class Name  should start with Capital Letter :{} ".format(
                    cls.__name__[0]
                )
            )
...
class log(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        message = """                       # Form Message
            ...
            """.format(
            FunName, end - start, self.func.__name__, sys.getsizeof(self.func), start
        )
